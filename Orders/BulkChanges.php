...
class BulkChanges
{
    ...
    {
        if (empty(sanitize_text_field($_REQUEST['response_force_create']))) {
            return;
        } // Exit
    ...
    {
        if (empty($_REQUEST['response_start_bulk_shipments'])) {
            return;
        } // Exit
    ...
    {
        if (empty($_REQUEST['response_force_latest_status'])) {
            return;
        }
